...
from webssh_app.tools.tools import get_key_obj
import socket
import json
...
class SSH:
    ...
    def connect(self, host, user, password=None, ssh_key=None, cmd=None, port=22, timeout=60,
        ...
        try:
            ...
            if cmd != None:
                ...
                self.channel.send('sh /root/logScan.sh\n')
                self.channel.recv(30)
                self.channel.recv(30)
